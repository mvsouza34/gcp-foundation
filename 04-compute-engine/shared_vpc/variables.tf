...
variable "subnetwork" {
  ...
  # default = "projects/dt-sandbox-host-proj/regions/us-central1/subnetworks/dt-sandbox-service-proj-cluster-vpc-dev"
  default = "dt-sandbox-service-proj-cluster-vpc-dev"
}
